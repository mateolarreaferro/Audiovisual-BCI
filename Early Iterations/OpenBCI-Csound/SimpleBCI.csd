...
instr 1
    ...
    ; Extract and scale alpha band values (index 2 of the 5 bands) - all 16 channels
    if kk1 > 0 then
    ...
    ; Fallback smoothing when no data received - all 16 channels
    if kk1 == 0 then
...
instr 2
    ...
    ; Generate oscillators modulated by BCI alpha waves - 8 channels
